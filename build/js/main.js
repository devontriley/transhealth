...
if(mobileDetected == true) $("html").addClass("mobile");
...
// Secondary Hero Anchor Links
let anchorLinks = $('.hero.secondary .anchorLinks');
if(anchorLinks.length)
{
    $('body').on('click', '.hero.secondary .anchorLinks a', function(e)
    {
        let href = $(this).attr('href');
        let target = $(href);
        let header = $('#header');

        if(target.length)  $("html, body").animate({scrollTop: (target.offset().top - 30)}, 750);
