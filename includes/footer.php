        ...
        <div class="row">
            <div class="col-md-3 logo-col">
                <a class="logo-link" href="<?php echo home_url(); ?>" aria-label="Return to Home Page">
                    <svg class="footer-logo" viewBox="0 0 500.747 111.569">
                        <use href="#transhealth-logo"></use>
                    </svg>
                </a>
            ...
            <div class="col-md-4 feedback">
                <div class="inner">
                    ...
                    <a href="<?php echo get_bloginfo('url') ?>/contact-us" class="btn mt-3">Let us know how we did</a>
                </div>
            </div>
        </div>
    </div>
